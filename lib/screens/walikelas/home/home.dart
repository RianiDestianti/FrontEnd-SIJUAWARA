...
import 'package:skoring/screens/walikelas/home/services/walikelas_data_service.dart';
import 'package:skoring/screens/walikelas/home/utils/chart_utils.dart';
import 'package:skoring/screens/walikelas/home/widgets/chart_widgets.dart';
import 'package:skoring/screens/walikelas/home/widgets/header_widgets.dart';
import 'package:skoring/screens/walikelas/home/widgets/section_widgets.dart';
...
class HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // ✅ extendBody allows content to go behind the floating navbar
      extendBody: true,
                ...
                child: FadeTransition(
                  ...
                  child: RefreshIndicator(
                    ...
                    child: SingleChildScrollView(
                      ...
                      // ✅ bottom padding so content isn't hidden behind floating navbar
    ...
    return Container(
      ...
      child: Padding(
        padding: EdgeInsets.fromLTRB(
          headerPadding,
          MediaQuery.of(context).padding.top + (isSmallScreen ? 12 : 16),
          headerPadding,
          isSmallScreen ? 20 : 24,
        ),
        child: Column(
